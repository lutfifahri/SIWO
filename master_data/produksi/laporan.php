                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="row">
                                <div class="col d-flex align-items-center">
                                    <h4 class="font-weight-bold">Laporan Grafik Produksi</h4>
                                </div>
                                <div class="col-auto">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mb-3">
                                                        <select name="jenis" id="jenis" class="form-control">
                                                            <option <?= isset($_POST['filter']) ? ($_POST['jenis'] == "DEKORASI" ? "selected" : "") : "" ?> value="DEKORASI">Dekorasi</option>
                                                            <option <?= isset($_POST['filter']) ? ($_POST['jenis'] == "DOKUMENTASI" ? "selected" : "") : "" ?> value="DOKUMENTASI">Dokumentasi</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-12">
                        ...
                        <div class="card-footer">
                            <?php if (isset($_POST['filter'])) : ?>
                                <a href="laporan/produksi.php?tahun=<?= $_POST['tahun'] ?>&jenis=<?= $_POST['jenis'] ?>" class="btn btn-primary float-right" target="_blank">Cetak</a>
                            <?php else : ?>
                                <a href="laporan/produksi.php" class="btn btn-primary float-right" target="_blank">Cetak</a>
                            <?php endif; ?>
                        </div>
                        <!-- /.card-body -->
                    </div>
...
$query = "SELECT * FROM tb_produksi WHERE jenis LIKE '%$jenis%'";
