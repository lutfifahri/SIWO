                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="row">
                                <div class="col d-flex align-items-center">
                                    <h4 class="font-weight-bold">Laporan Grafik Talent</h4>
                                </div>
                                <div class="col-auto">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mb-3">
                                                        <select name="jenis" id="jenis" class="form-control">
                                                            <option <?= isset($_POST['filter']) ? ($_POST['jenis'] == "MC" ? "selected" : "") : "" ?> value="MC">MC</option>
                                                            <option <?= isset($_POST['filter']) ? ($_POST['jenis'] == "BAND" ? "selected" : "") : "" ?> value="BAND">Band</option>
                                                            <option <?= isset($_POST['filter']) ? ($_POST['jenis'] == "MUA" ? "selected" : "") : "" ?> value="MUA">MUA</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-12">
                        ...
                        <div class="card-footer">
                            <?php if (isset($_POST['filter'])) : ?>
                                <a href="laporan/talent.php?tahun=<?= $_POST['tahun'] ?>&jenis=<?= $_POST['jenis'] ?>" class="btn btn-primary float-right" target="_blank">Cetak</a>
                            <?php else : ?>
                                <a href="laporan/talent.php" class="btn btn-primary float-right" target="_blank">Cetak</a>
                            <?php endif; ?>
                        </div>
                        <!-- /.card-body -->
                    </div>
...
$query = "SELECT * FROM tb_talent WHERE jenis LIKE '%$jenis%'";
