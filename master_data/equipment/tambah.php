...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tb_equipment (nama, harga, jenis, detail) VALUES ('$nama', '$harga', '$jenis', '$detail')";
    if ($conn->query($query)) {
        ...
        for ($i = 0; $i < count($_FILES['gambar']['name']); $i++) {
            ...
            $query = "INSERT INTO tb_gambar_equipment (id_equipment, gambar) VALUES ($last_id, '$target_file')";
            $conn->query($query);
        }
        echo "<script>alert('Data Equipment berhasil ditambahkan!');</script>";
                    ...
                    <div class="card card-primary shadow">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="nama">Jenis Equipment</label>
