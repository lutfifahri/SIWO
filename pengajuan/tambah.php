                    ...
                    <div id="a" class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Identitas Mempelai</h3>
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="form-group text-center">
                                                    <label for="exampleInputEmail1">Identitas Mempelai Laki-Laki</label>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nik_l">NIK</label>
                                                    <input type="text" class="form-control" id="nik_l" name="nik_l" placeholder="Masukkan NIK">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_l">Nama Lengkap</label>
                                                    <input type="text" class="form-control" id="nama_l" name="nama_l" placeholder="Masukkan Nama Lengkap Suami">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_ayah_l">Nama Ayah</label>
                                                    <input type="text" class="form-control" id="nama_ayah_l" name="nama_ayah_l" placeholder="Masukkan Nama Lengkap Suami">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_ibu_l">Nama Ibu</label>
                                                    <input type="text" class="form-control" id="nama_ibu_l" name="nama_ibu_l" placeholder="Masukkan Nama Lengkap Suami">
                                                </div>
                                                <div class="form-group">
                                                    <label for="tempat_lahir_l">Tempat Lahir</label>
                                                    <input type="text" class="form-control" id="tempat_lahir_l" name="tempat_lahir_l" placeholder="Masukkan Tempat Lahir">
                                                </div>
                                                <div class="form-group">
                                                    <label for="tanggal_lahir_l">Tanggal Lahir</label>
                                                    <input type="date" class="form-control" id="tanggal_lahir_l" name="tanggal_lahir_l">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nomor_telepon_l">Nomor Telepon</label>
                                                    <input type="text" class="form-control" id="nomor_telepon_l" name="nomor_telepon_l" placeholder="Masukkan Nomor Telepon">
                                                </div>
                                                <div class="form-group">
                                                    <label for="foto_l">Foto Mempelai Pria</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="tempat_wedding" name="tempat_wedding" placeholder="Masukkan Tempat Wedding">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group text-center">
                                                    <label for="exampleInputEmail1">Identitas Mempelai Wanita</label>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nik_p">NIK</label>
                                                    <input type="text" class="form-control" id="nik_p" name="nik_p" placeholder="Masukkan NIK">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_p">Nama Lengkap</label>
                                                    <input type="text" class="form-control" id="nama_p" name="nama_p" placeholder="Masukkan Nama Lengkap Suami">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_ayah_p">Nama Ayah</label>
                                                    <input type="text" class="form-control" id="nama_ayah_p" name="nama_ayah_p" placeholder="Masukkan Nama Lengkap Suami">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_ibu_p">Nama Ibu</label>
                                                    <input type="text" class="form-control" id="nama_ibu_p" name="nama_ibu_p" placeholder="Masukkan Nama Lengkap Suami">
                                                </div>
                                                <div class="form-group">
                                                    <label for="tempat_lahir_p">Tempat Lahir</label>
                                                    <input type="text" class="form-control" id="tempat_lahir_p" name="tempat_lahir_p" placeholder="Masukkan Tempat Lahir">
                                                </div>
                                                <div class="form-group">
                                                    <label for="tanggal_lahir_p">Tanggal Lahir</label>
                                                    <input type="date" class="form-control" id="tanggal_lahir_p" name="tanggal_lahir_p">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nomor_telepon_p">Nomor Telepon</label>
                                                    <input type="text" class="form-control" id="nomor_telepon_p" name="nomor_telepon_p" placeholder="Masukkan Nomor Telepon">
                                                </div>
                                                <div class="form-group">
                                                    <label for="foto_p">Foto Mempelai Wanita</label>
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group text-center">
                                            ...
                                            <div class="d-flex justify-content-center mt-5">
                                                <img id="preview-foto-l" src="assets/img/pp.png" class="img-thumbnail img-fluid mr-2" style="width: 300px; height: 400px; object-fit: cover;">
                                                <img id="preview-foto-p" src="assets/img/pp.png" class="img-thumbnail img-fluid ml-2" style="width: 300px; height: 400px; object-fit: cover;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
